...
expName = '正向情緒與意義感研究二'  # from the Builder filename that created this script
expInfo = {
    'participant': f"{randint(1, 90):02.0f}",
    'session': '001',
    'group': '',
}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\User\\Desktop\\psychopy\\Experiment2\\PAMIL_exp2_lastrun.py',
...
Emotion_Movie = visual.MovieStim(
    ...
    filename=expInfo['group'], movieLib='ffpyplayer',
